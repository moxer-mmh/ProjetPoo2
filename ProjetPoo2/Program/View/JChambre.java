...
public class JChambre extends JFrame {
	...
	public JChambre() {
		...
		background.setBounds(0, 0, 786, 563);
		...
		JButton btnModifRoom = Design.createButton("MODIFIER", 21, 56, 108, 23);
		...
		typeChambre.setBackground(new Color(0, 56, 113));
		typeChambre.setModel(new DefaultComboBoxModel(TypeChambre.values()));
		typeChambre.setBounds(10, 108, 192, 30);
		panel.add(typeChambre);

		numChambre = new JTextField();
		numChambre.setBackground(new Color(0, 56, 113));
		...
		etatChambre.setModel(new DefaultComboBoxModel(EtatChambres.values()));
		etatChambre.setBackground(new Color(0, 56, 113));
		...
		table.setBackground(new Color(0, 56, 113));
