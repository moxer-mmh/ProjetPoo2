...
public class CtrlClient {
	...
	public static void actionAddClient(JButton btnNewButton, JFrame frame, JTextField nomClient,
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (nom.isEmpty() || prenom.isEmpty()) {
					JOptionPane.showMessageDialog(null, "Veuillez saisir votre nom et prénom.", "Erreur",
				...
				if (!nom.matches("[a-zA-Z]+") || !prenom.matches("[a-zA-Z]+")) {
					JOptionPane.showMessageDialog(null,
							"Le nom et le prénom ne doivent contenir que des caractères alphabétiques.", "Erreur",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
	...
	public static void listeClient() {
		...
		Client rowList : Client.clients.values()) {
