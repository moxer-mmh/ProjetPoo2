...
public class JChambre extends JFrame {
	...
	public JChambre() {
		...
		btnModifier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				modelT = (DefaultTableModel) table.getModel();
		          ...
		          modelT.setValueAt(numChambre.getText(),selectedRow,0);
		          modelT.setValueAt(typeChambre.getSelectedItem(),selectedRow,1);
		          modelT.setValueAt(EtatChambres.LIBRE.name(),selectedRow,2);
		...
		table.addMouseListener(new MouseAdapter() {
        		...
        		selectedRow = table.getSelectedRow(); 
        		int columnIndex = 0; // Assuming you want the value from the second column

                DefaultTableModel model = (DefaultTableModel) table.getModel();
                Object value1 = model.getValueAt(selectedRow, columnIndex);
                Object value2 = model.getValueAt(selectedRow,++columnIndex);
		 ...
		 roomType=(TypeChambre) typeChambre.getSelectedItem();
	        ...
	        if (r.chambres == null || !r.chambres.containsKey(roomNumber)) {
	          ...
	          numChambre.setText(String.valueOf(row));
	        	...
	        	JOptionPane.showMessageDialog(frame, "La chambre spécifiée existe déjà", "Erreur", JOptionPane.ERROR_MESSAGE);
