...
public class JAdmin extends JFrame {
	...
	public JAdmin() {
        ...
        mainPanel.setBounds(202, 11, 841, 580); // Redimensionnement du mainPanel pour s'adapter à la largeur et à la hauteur de la fenêtre
		...
		icone.setBounds(0, 0, 500, 500); // Redimensionnement de l'icône pour s'adapter à la largeur et à la hauteur du mainPanel
        mainPanel.add(icone);
