...
public class JResrvationClient extends JFrame {
	...
	public JResrvationClient(String nom, String prenom) {
		...
		CtrlReservationClient.makeReservation(btnEnregistrer,dateDebut.getText(), dateFin.getText(),etatChambreC,nomC.getText(), prenomC.getText());
		 ...
		 pMesReserv.setVisible(false);
           ...
           // pMesReserv.add(tableClient);)
	        ...
	        JButton reservClient = new JButton("Mes RESERVATION");
	         ...
	         CtrlReservationClient.actionReservClient( reservClient,pMesReserv, pReservation,contentPane, panel_1, nom,prenom,
